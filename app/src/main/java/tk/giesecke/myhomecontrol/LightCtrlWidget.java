 ...
 */
public class LightCtrlWidget extends AppWidgetProvider {
	...
	public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
		...
		RemoteViews rvLightCtrlWidget = new RemoteViews(context.getPackageName(), R.layout.light_ctrl_widget);
		...
		Intent serviceIntent = new Intent(context, LightCtrlWidgetClick.class);
