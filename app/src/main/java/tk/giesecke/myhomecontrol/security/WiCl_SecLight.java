 ...
 */
public class WiCl_SecLight extends IntentService {

	/** Debug tag */
	private static final String DEBUG_LOG_TAG = "MHC-LIGHT-W";

	public WiCl_SecLight() {
		super("WiCl_SecLight");
	}
	...
	protected void onHandleIntent(Intent intent) {
		if (intent != null) {
			...
			if (extras != null) {
				...
				Wi_SecLight.updateAppWidget(this, appWidgetManager, mAppWidgetId, true);
	...
	private class changeBackWidget extends TimerTask
	{
		...
		@Override
		public void run() {
			Wi_SecLight.updateAppWidget(context, appWidgetManager, appWidgetId, false);
		}
	}
}
