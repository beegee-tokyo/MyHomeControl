...
public class Cl_Utilities extends Cl_MyHomeControl {
...
//				return currentSSID.equalsIgnoreCase(MY_LOCAL_SSID);
	...
	public static int getNotifSounds(Context thisAppContext, ArrayList<String> notifNames, ArrayList<String> notifUri, boolean isSelAlarm) {
		...
		String lastUri;
		if (isSelAlarm) {
			lastUri = mPrefs.getString(tk.giesecke.myhomecontrol.Cl_MyHomeControl.prefsSecurityAlarm, "");
		} else {
			lastUri = mPrefs.getString(tk.giesecke.myhomecontrol.Cl_MyHomeControl.prefsSolarWarning, "");
		}
