 ...
 */
public class AirconWidgetHelper extends IntentService {

	/** Debug tag */
	private static final String DEBUG_LOG_TAG = "MHC-AC-W";

	public AirconWidgetHelper() {
		super("AirconWidgetHelper");
	}
	...
	private boolean espComm(String cmd) {
		...
		String url = mPrefs.getString(
				MyHomeControl.deviceNames[MyHomeControl.aircon1Index],
				"NA");
		try {
