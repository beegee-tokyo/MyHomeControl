 ...
 */
public class Wi_Aircon extends AppWidgetProvider {
	...
	public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
		...
		if (isRunning) {
			rvACview.setInt(R.id.bt_ac_wid_timer, "setBackgroundResource", R.drawable.dr_orange_round_button);
			rvACview.setTextViewText(R.id.bt_ac_wid_timer, timerEnd);
		} else {
			rvACview.setInt(R.id.bt_ac_wid_timer, "setBackgroundResource", R.drawable.dr_green_round_button);
		...
		Intent serviceIntent = new Intent(context, WiCl_Aircon.class);
		...
		serviceIntent = new Intent(context, WiCl_Aircon.class);
		...
		Intent appIntent = new Intent(context, Cl_MyHomeControl.class);
		appIntent.putExtra("view", tk.giesecke.myhomecontrol.Cl_MyHomeControl.view_aircon_id);
		appIntent.putExtra("aircon", tk.giesecke.myhomecontrol.Cl_MyHomeControl.view_aircon_id);
